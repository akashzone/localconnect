...
const AdminApplicationDetails = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Main Grid: Application Information (Left / Top) & Related Stakeholders (Right / Bottom) */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        
        {/* Left Section (2/3 width) - Application Details & Project Info */}
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-white border border-[#D8D2C4] rounded-[6px] p-6 shadow-[4px_4px_0px_#1B2430] space-y-5">
            <div className="flex flex-col sm:flex-row justify-between items-start gap-3 pb-3 border-b border-[#D8D2C4]/60">
              <div>
                ...
                <h2 className="font-['Space_Grotesk'] font-bold text-xl text-[#1B2430] mt-1.5">
                  Proposal Details
                </h2>
              </div>
              <span className={`inline-flex items-center px-3 py-1 text-xs font-bold rounded-[3px] border uppercase tracking-wider text-[10px] ${statusStyle}`}>
                {status}
              </span>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-[#FAF8F3] p-4 rounded border border-[#D8D2C4] text-sm">
              <div>
                <span className="font-['IBM_Plex_Mono'] text-[10px] text-[#6B6459] uppercase tracking-wider font-semibold block">Estimated Duration</span>
                <span className="font-semibold text-[#1B2430] block mt-1">{estimatedDuration || "Not provided"}</span>
              </div>
              <div>
                <span className="font-['IBM_Plex_Mono'] text-[10px] text-[#6B6459] uppercase tracking-wider font-semibold block">Submitted On</span>
            ...
            <div className="space-y-1.5">
              <span className="font-['IBM_Plex_Mono'] text-xs text-[#6B6459] uppercase tracking-wider font-semibold block">Cover Letter Proposal</span>
            ...
            {workSubmission && workSubmission.workLink && (
              <div className="space-y-3 p-4 bg-emerald-50 border border-emerald-200/80 rounded-[4px] text-sm font-['IBM_Plex_Sans']">
                ...
                <div>
                  <span className="text-[10px] text-[#6B6459] font-['IBM_Plex_Mono'] uppercase tracking-wider font-semibold block">Submission Link</span>
                  <a href={workSubmission.workLink} target="_blank" rel="noreferrer" className="text-[#0F6B5C] hover:underline font-semibold flex items-center gap-1 mt-0.5 truncate">
                ...
                {workSubmission.remarks && (
                  <div>
                    <span className="text-[10px] text-[#6B6459] font-['IBM_Plex_Mono'] uppercase tracking-wider font-semibold block">Remarks</span>
                ...
                {workSubmission.submittedAt && (
                  <span className="text-[10px] text-[#6B6459] font-['IBM_Plex_Mono'] block">Submitted: {formatDate(workSubmission.submittedAt)}</span>
                )}
              </div>
            )}
          </section>
          ...
          {projectId && (
            <section className="bg-white border border-[#D8D2C4] rounded-[6px] p-6 shadow-[4px_4px_0px_#1B2430] space-y-4">
              ...
              <div className="space-y-3 font-['IBM_Plex_Sans'] text-sm text-[#1B2430]">
                <div>
                ...
                <p className="text-xs text-[#6B6459] line-clamp-3 leading-relaxed mt-2 p-3 bg-[#FAF8F3] rounded border border-[#D8D2C4]/60">
        ...
        {/* Right Section (1/3 width) - Student Profile & Business Client Info */}
        <div className="space-y-6">
          ...
          <section className="bg-white border border-[#D8D2C4] rounded-[6px] p-5 shadow-[4px_4px_0px_#1B2430] space-y-4">
            ...
            {studentId ? (
              <div className="space-y-3.5 text-xs font-['IBM_Plex_Sans'] text-[#1B2430]">
                ...
                {studentProfile ? (
                  <div className="space-y-3 bg-[#FAF8F3] p-3.5 rounded border border-[#D8D2C4] leading-relaxed">
                    <div>
                      <span className="font-['IBM_Plex_Mono'] text-[9px] text-[#6B6459] uppercase tracking-wider block font-semibold">Bio</span>
                      <p className="text-xs text-[#6B6459] mt-0.5 line-clamp-4">{studentProfile.bio || "Not provided"}</p>
                    </div>
                    <div>
                    ...
                    <div className="pt-2.5 border-t border-[#D8D2C4]/60 flex flex-col gap-1.5">
                      {studentProfile.resume && (
                        <a href={studentProfile.resume} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-xs text-[#0F6B5C] hover:underline font-semibold">
                          <FontAwesomeIcon icon={faFilePdf} className="text-red-700 text-[10px]" />
                          <span>View Resume</span>
                        </a>
                      )}
                      {studentProfile.portfolio && (
                        <a href={studentProfile.portfolio} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-xs text-[#0F6B5C] hover:underline font-semibold">
                          <FontAwesomeIcon icon={faGlobe} className="text-[10px]" />
                          <span>Portfolio Link</span>
                        </a>
                      )}
                      {studentProfile.github && (
                        <a href={studentProfile.github.startsWith("http") ? studentProfile.github : `https://github.com/${studentProfile.github}`} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-xs text-[#0F6B5C] hover:underline font-semibold">
                          <FontAwesomeIcon icon={faGithub} className="text-[10px]" />
                          <span>GitHub Profile</span>
                        </a>
                      )}
                      {studentProfile.linkedIn && (
                        <a href={studentProfile.linkedIn.startsWith("http") ? studentProfile.linkedIn : `https://linkedin.com/in/${studentProfile.linkedIn}`} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-xs text-[#0F6B5C] hover:underline font-semibold">
          ...
          {/* Business owner stakeholder Card */}
          <section className="bg-white border border-[#D8D2C4] rounded-[6px] p-5 shadow-[4px_4px_0px_#1B2430] space-y-4">
            <h3 className="font-['Space_Grotesk'] font-bold text-md text-[#1B2430] pb-2 border-b border-[#D8D2C4] flex items-center gap-2">
              ...
              <div className="space-y-3.5 text-xs font-['IBM_Plex_Sans'] text-[#1B2430]">
                ...
                {businessProfile ? (
                  <div className="space-y-3 bg-[#FAF8F3] p-3.5 rounded border border-[#D8D2C4] leading-relaxed">
                    ...
                    <div>
                      <span className="font-['IBM_Plex_Mono'] text-[9px] text-[#6B6459] uppercase tracking-wider block font-semibold">Address Location</span>
                      <p className="text-xs text-[#6B6459] truncate">{businessProfile.address || "Not provided"}</p>
                    </div>
                    <div className="pt-2.5 border-t border-[#D8D2C4]/60 flex flex-col gap-1.5">
                      {businessProfile.socialLinks?.website && (
                        <a href={businessProfile.socialLinks.website} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-xs text-[#0F6B5C] hover:underline font-semibold">
                          <FontAwesomeIcon icon={faGlobe} className="text-[10px]" />
                          <span>Website</span>
                        </a>
                      )}
                      {businessProfile.socialLinks?.linkedin && (
                        <a href={businessProfile.socialLinks.linkedin.startsWith("http") ? businessProfile.socialLinks.linkedin : `https://linkedin.com/company/${businessProfile.socialLinks.linkedin}`} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-xs text-[#0F6B5C] hover:underline font-semibold">
                          <FontAwesomeIcon icon={faLinkedin} className="text-[10px]" />
                          <span>LinkedIn</span>
                        </a>
                      )}
